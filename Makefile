...
PROJECT_NAME = Robot
TOP_MODULE = top
VHDL_FILES = rtl/top/top.vhd rtl/uart_protocol/uart_protocol.vhd open-logic/src/base/vhdl/olo_base_pkg_attribute.vhd open-logic/src/base/vhdl/olo_base_pkg_logic.vhd open-logic/src/base/vhdl/olo_base_pkg_math.vhd open-logic/src/base/vhdl/olo_base_pkg_array.vhd open-logic/src/base/vhdl/olo_base_fifo_sync.vhd open-logic/src/base/vhdl/olo_base_strobe_gen.vhd open-logic/src/base/vhdl/olo_base_reset_gen.vhd open-logic/src/base/vhdl/olo_base_ram_sdp.vhd open-logic/src/intf/vhdl/olo_intf_uart.vhd open-logic/src/intf/vhdl/olo_intf_sync.vhd
BUILD_DIR = build
